...
3. **Key Findings & Models**:
   - For `SH-124-B3`, the rocking curves resolve discrete, sharp tilt peaks at specific $\phi$ angles, leading directly to the **Epitaxial Locking Model** (in-plane substrate locking).
...
![Integrated Bragg peak areas of calcite (104) and vaterite (110) as a function of the azimuthal rotation angle $\phi$, illustrating the narrow in-plane epitaxial window of the vaterite phase. High-resolution vector graphics are available in [fig6_phase_metrics_vs_phi.svg](../figures/fig6_phase_metrics_vs_phi.svg).](../figures/fig6_phase_metrics_vs_phi.png){width=85%}
