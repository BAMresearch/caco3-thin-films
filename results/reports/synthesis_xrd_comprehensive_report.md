...
To clarify how these disparate experimental observations are integrated into the final growth model, the flowchart below outlines the path from initial screening to the unified helical growth mechanism:

![**Figure 0:** Structural characterisation scheme and information flow diagram. The diagram outlines how phase identification and initial 2D-XRD texture screening feed into the high-resolution rocking curve sweeps, which resolve the split tilt domains. These domains are then interpreted through the lens of substrate alignment, culminating in the unified helical columnar growth model.](../figures/fig_flowchart.png){width=95%}
...
4. **Unified Synthesis Mechanism (Bottom)**: By linking both models, we establish that they are two expressions of the same physical growth process—**Helical Columnar Growth**—where the degree of substrate templating determines whether the precessing helical columns are in-plane locked or azimuthally free.
